export const MODEL_ID = "j-hartmann/emotion-english-distilroberta-base";
export const APP_TITLE = "Story Emotion Arc";
export const APP_SUBTITLE = "7 Ekman Emotions";
export const APP_DESCRIPTION =
  "Paste a multi-paragraph story to see how emotions rise and fall across the narrative. Each paragraph is scored for 7 basic human emotions.";

export const EMOTIONS = [
  { label: "anger", color: "#e74c3c", emoji: "\u{1F620}" },
  { label: "disgust", color: "#27ae60", emoji: "\u{1F922}" },
